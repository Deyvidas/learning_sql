- [Использование вложенных запросов (1х1)](#использование-вложенных-запросов-1х1)
- [Использование вложенных запросов (n x 1)](#использование-вложенных-запросов-n-x-1)
- [Операторы `ANY` и `ALL` для вложенных запросов (n x 1)](#операторы-any-и-all-для-вложенных-запросов-n-x-1)
---
...
---
## Использование вложенных запросов (1х1)
Пример 1:
...
```
---
## Использование вложенных запросов (n x 1)
...
```
---
## Операторы `ANY` и `ALL` для вложенных запросов (n x 1)
